...
public class Appointment {
    ...
    public String getDetails() {
        ...
        details.append("Statusi: ").append(status).append("\n");
        details.append("Pacienti: ").append(patient.getName())
               .append(" (ID: ").append(patient.getId()).append(")\n");
        details.append("Doktori: ").append(staff.getName())
               .append(" - ").append(staff.getSpecialty()).append("\n");
        if (status == AppointmentStatus.COMPLETED && !report.isEmpty()) {
            details.append("Raporti: ").append(report).append("\n");
        }//Only show the report if the appointment is completed AND the report is not empty
        details.append("====================================");
